...
```{r animation-options, include = FALSE}
...
datasaurus %>%
  ...
  select(-dataset) %>%
  kable(caption = "Summary statistics of 12 datasets",
...
```{r datasaurus-graph, dependson = c('datasaurus-import', 'animation-options'), echo = FALSE, fig.show = "animate", warning = FALSE}
