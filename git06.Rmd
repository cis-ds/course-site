...
The short answer is that Git works with Python just as well as R. In fact, you can use RStudio as a Python IDE to edit and run Python (`.py`) scripts. That said, there are plenty of IDEs specifically for Python that have Git integrated. Otherwise, the fallback option is to use Git from the shell or whatever [Git client you chose to install](git02.html).
