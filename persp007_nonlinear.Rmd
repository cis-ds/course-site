...
wage_knots <- function(data, degree = 3, df = NULL){
...
# estimate mse for knots in 1:10
(wage_degree_mse <- data_frame(knots = 1:10,
                            mse = map_dbl(knots, ~ wage_knots(wage_kfold, df = .))))
```
...
Here is an example of a local linear regression (highest degree equal to 1) on the `ethanol` dataset in the `lattice` package:
