...
**Hint: think about how to [split your plots to shore different subsets of data.](http://r4ds.had.co.nz/data-visualisation.html#facets)**
...
<details> 
  ...
  <p>
```{r text}
ggplot(gapminder, aes(gdpPercap, lifeExp, label = country)) +
  geom_smooth() +
  geom_text()
```
  </p>
