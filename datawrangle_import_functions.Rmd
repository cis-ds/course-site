...
```{r data-gen, include = FALSE, cache.extra = c(file.info("data/sim-data-small.csv"), file.info("data/sim-data-large.csv"))}
n_row_s <- 500000
...
`feather` is generally faster than RDS and `read_csv()`.^[Notice that the x-axis is logarithmically scaled.]
