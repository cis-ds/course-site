...
* Avoid densely packing your poster with lots of words and paragraphs
* Have a logical flow
* Bullet points, not paragraphs
* Use graphs instead of tables
* Make sure your font is legible
* Avoid dark backgrounds
* Label your graphs and sections with **informative phrases**
* Make sure the graphs themselves are **functional** and **pretty**
