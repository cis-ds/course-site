...
1. The `key`, or the name of the variable whose values form the column names. Here that is `year`. **Note that we create this name ourselves, it does not already exist in the untidy data frame.**
