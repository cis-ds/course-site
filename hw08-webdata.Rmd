---
title: "Homework 08: Collecting data from the web"
output: html_document
---

# Overview

Due before class Wednesday February 29th.
...
Check plus: Estimate a statistical model for the `gapminder` question, or do something beyond producing a graph. Write an API function that uses authentication.
