...
Let's demonstrate why you should want to learn to program. What are the advantages over GUI software, such as Stata?
...
* What are we using with the `source()` function?
* What does `1000` refer to?
* What is the difference between `data` and `data2`?
