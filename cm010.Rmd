...
* Define an information dashboard
* Demonstrate information dashboards in R
...
* [R Markdown: The Definitive Guide](https://bookdown.org/yihui/rmarkdown/) - basically what it says. The definitive reference guide to R Markdown and the major publication formats and extensions.
