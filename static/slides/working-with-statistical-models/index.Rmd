...
```{r titanic-model}
ggplot(titanic_train, aes(Age, Survived, color = Sex)) +
  geom_point() +
  geom_smooth(
    method = "glm",
...
<div style="width:100%;height:0;padding-bottom:75%;position:relative;"><iframe src="https://giphy.com/embed/3ofT5RxXymlX4na3p6" width="100%" height="100%" style="position:absolute" frameBorder="0" class="giphy-embed" allowFullScreen></iframe></div>
