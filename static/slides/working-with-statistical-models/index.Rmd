...
```{r}
#| label = "complex-model-plot",
#| dependson = "complex-model",
#| fig.height = 8
...
```{r}
#| label = "titanic-marg-eff",
#| dependson = "titanic-pred",
#| fig.height = 8
...
```{r}
#| label = "obama-cond-plot",
#| dependson = "obama-cond"
ce_obama %>%
