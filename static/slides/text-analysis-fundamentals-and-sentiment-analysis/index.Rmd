...
# Wrangling text data with `tidytext`
...
.task[How often is each U.S. state mentioned in a popular song?]
...
```{r}
#| echo: false
include_graphics(path = "https://media.giphy.com/media/2aJM3TUEaY9Yz166e8/giphy.gif")
```
...
```{r}
#| echo: false
include_graphics(path = "https://media.giphy.com/media/2wXrSikk2c8llaunlr/giphy.gif")
```
...
include_graphics(path = "https://media.giphy.com/media/pI2paNxecnUNW/giphy.gif")
```
