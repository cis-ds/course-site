...
```{r penguins-example, eval = FALSE, warning = FALSE, message = FALSE}
# load packages
library(tidyverse)
...
lm(body_mass_g ~ flipper_length_mm, data = penguins) %>%
  ...
  knitr::kable(digits = 2, col.names = c("Variable", "Estimate", "Standard Error",
                                         "T-statistic", "P-Value"))
...
```{r penguins-example, fig.height = 6, echo = FALSE, warning = FALSE, message = FALSE}
```
