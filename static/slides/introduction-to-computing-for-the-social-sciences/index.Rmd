...
```{r out.height = "50%", out.width = "50%", fig.width = 5}
...
library(tidyverse)
library(rtweet)
data <- get_timeline(c("MeCookieMonster", "Grover", "elmo", "CountVonCount"), 3000)
ts_plot(data, "weeks")
```
...
# plot weekly tweet frequency
ts_plot(tmls, by = "weeks")
```
...
```{r sesame-good, echo = FALSE, message = FALSE, cache = TRUE, out.width = "80%"}
```
