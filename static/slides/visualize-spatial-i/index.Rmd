...
.panelset[
```{r}
#| panelset = c(output = "Plot", source = "Code"),
#| out.width = "70%",
#| message = FALSE
nyc_bb <- c(
  left = -74.263045, #<<
...
.panelset.sideways[
```{r}
#| panelset = c(source = "Code", output = "Plot"),
#| out.width = "95%",
#| fig.width = 12
ggplot(
