...
```{r}
#| label = "titanic_tree_complicated",
#| dependson = "titanic_tree_full"
...
```{r}
#| label = "mse-poly",
#| dependson = c("auto_split", "mse-poly-plot")
...
```{r}
#| label = "accuracy_age_sex_x_test_set",
#| dependson = "age_woman_cross",
#| message = FALSE,
#| echo = TRUE,
#| collapse = TRUE
...
```{r}
#| label = "loocv-function-test",
#| dependson = "loocv-function",
#| echo = TRUE
...
```{r}
#| label = "loocv",
#| dependson = c("Auto", "loocv-function"),
#| echo = TRUE
...
```{r}
#| label = "titanic_loocv",
#| dependson = "titanic_loocv_function",
#| echo = TRUE
...
```{r}
#| label = "10_fold_auto_loocv",
#| dependson = c("10_fold_auto", "loocv_poly")
...
```{r}
#| label = "titanic_kfold",
#| dependson = "titanic_kfold_function",
#| echo = TRUE
