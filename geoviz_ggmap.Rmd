...
```{r bb-chicago-stamen}
chicago_stamen <- get_stamenmap(bbox = c(left = -87.936287,
                                         bottom = 41.679835,
                                         right = -87.447052,
                                         top = 42.000835),
                                zoom = 11)
...
get_stamenmap(bbox = c(left = -87.936287,
                       bottom = 41.679835,
                       right = -87.447052,
                       top = 42.000835),
              zoom = 12) %>%
...
chicago_google <- get_googlemap(center = c(lon = -87.65, lat = 41.855))
ggmap(chicago_google)

get_googlemap(center = c(lon = -87.65, lat = 41.855),
              zoom = 12) %>%
  ggmap()
