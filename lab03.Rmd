...
# set our base theme to black and white
theme_set(theme_bw())
...
```
* "Customizing the look and feel" modified from Selva Prabhakaran's [*The Complete ggplot2 Tutorial - Part 2 | How To Customize ggplot2 (Full R code)*](http://r-statistics.co/Complete-Ggplot2-Tutorial-Part2-Customizing-Theme-With-R-Code.html), licensed under the [CC BY-NC 3.0 Creative Commons License](https://creativecommons.org/licenses/by-nc/3.0/).
