...
misclass <- formatC((1 - mean(predict(titanic_tree) == titanic_tree_data$Survived, na.rm = TRUE)) * 100, digits = 3)
```
...
* Overall, this decision tree misclassifies $`r misclass`\%$ of the training set observations
...
1. Assess the decision tree's predictive accuracy.
    ...
    The model isn't too bad. It's misclassification error rate is $`r misclass`\%$ (based on the original data).
