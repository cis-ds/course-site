...
* [`rtweet`](http://rtweet.info/) is a relatively recent addition to the R package universe that allows you to access both the REST and streaming APIs. Alas, it is so recent I only discovered it last week and have not had adequate time to test it out and write out an exercise using it. You may find it more useful/user-friendly.
