...
In order to track changes and attribute them to the correct user, we need to tell Git your name and email address. Open the shell on your computer. From there, type the following commands:
