...
The twentieth-order polynomial provides the lowest mean squared error, so we should use that model, right? But what if we sample another 50 observations from the same population and estimate MSE for those observations?
