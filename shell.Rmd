...
NOTE FOR WINDOW USERS: If when you attempt to open the shell and you get the Command Prompt:

![](https://upload.wikimedia.org/wikipedia/commons/b/b3/Command_Prompt_on_Windows_10_RTM.png)

rather than Git Bash ([remember we installed this with Git](git01.html)), you need to open Git Bash manually. You should find it under the Start Menu > Git > Git Bash. If you're still confused, go back and watch the first three minutes of this [video tutorial on installing Git for Windows](https://www.youtube.com/watch?v=339AEqk9c-8).
