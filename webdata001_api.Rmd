...
3. Tell R your geonames username and the URL for the API.^[We have to manually specify the URL for the API due to [this error](https://github.com/ropensci/geonames/issues/16). Hopefully this will be fixed again soon.] You could run the line
