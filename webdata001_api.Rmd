...
`mp_maindataset()` includes a data frame describing each manifesto included in the database. For instance, how many manifestos have been published by each political party in Sweden?
...
Using the downloaded database, we can use **scaling functions** to identify each party manifesto on an ideological dimension. For example, how have the Democratic and Republican Parties in the United States changed ideologically over time?
