...
* Fork and clone [`shiny-demo`](https://github.com/uc-cfss/shiny-demo)
...
* Add a table showing the count of selected emplo per department
...
## Exercise: Use `uiOutput()` in our app to populate the job titles
