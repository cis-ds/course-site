...
1. Use your UChicago username and password to login (this is the same username/password you use for other UChicago online services, such as email).
1. You're done. You should see a fresh RStudio window in your browser.

> Only students in this course who have been approved by RCC can access this server. I will send a copy of the course roster to RCC on the first day of class so they can grant you access. If you were not registered on that day, contact me with your UChicago CNet ID and I'll request you access.
