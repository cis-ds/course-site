...
Only students in this course who have been approved by SSCS can access this server. If you cannot log on to the server, apply for an account at https://iota.uchicago.edu/ ([UChicago VPN](https://uchicago.service-now.com/it?id=kb_article&kb=KB00015292) required) and email [sscs@uchicago.edu](mailto:sscs@uchicago.edu) to let them know that you are enrolled in the class.
