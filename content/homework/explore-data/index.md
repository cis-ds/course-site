...
url_code: "https://github.com/cfss-su22/hw02"
---
...
Go [here](https://github.com/cfss-su22/hw02) to fork the repo.
...
I have included this dataset in the [`rcis`](https://github.com/cis-ds/rcis) library on GitHub. To install the package, use the command `devtools::install_github("cis-ds/rcis")` in R. If you don't already have the `devtools` library installed, you will get an error. Go back and install this first using `install.packages()`, then install `rcis`. The mass shootings dataset can be loaded using `data("mass_shootings")`.^[For the purposes of this assignment, I have performed some data cleaning of the underlying raw data. You can view the data cleaning code [here](https://github.com/cis-ds/rcis/blob/master/data-raw/mass-shootings.R).] Use the help function in R (`?mass_shootings`) to get detailed information on the variables and coding information.
