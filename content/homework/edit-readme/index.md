...
You need to register your GitHub username with me in order to access the repository, otherwise you will just get an error that says the web page does not exist. Submit your username using [this form](https://forms.gle/uMgGMa3h2dstx6Aq6). Expect to get an email from GitHub in the next 24 hours inviting you to join the `cfss-win22` course organization. Once you accept the invitation, you will be able to fork the repo.
