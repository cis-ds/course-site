...
url_code: "https://github.com/cfss-win21/hw06"
---
...
Due by 1:00 pm CT (Chicago) on November 10th.

# Fork the `hw06` repository

Go [here](https://github.com/cfss-win21/hw06) to fork the repo for homework 06.
