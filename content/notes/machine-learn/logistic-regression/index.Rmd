...
```{r}
#| label = "titanic-ols-old",
#| dependson = "titanic-ols"
# visualize predicted values
age_vals <- tibble(
  Age = 0:200
)
...
```{r}
#| label = "titanic-age-plot",
#| dependson = "titanic-age"
...
```{r}
#| label = "survive-age-woman-pred",
#| dependson = "survive-age-woman"
...
```{r}
#| label = "age-woman-cross-pred",
#| dependson = "age-woman-cross"
