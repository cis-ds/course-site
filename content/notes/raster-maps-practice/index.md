...
If you are copying-and-pasting code from this demonstration, use `chi_311 <- read_csv("https://info5940.netlify.app/data/chi-311.csv")` to download the file from the course website.
