...
If you want to visualize the transformations some tidyverse code makes to your data, [TidyDataTutor](https://tidydatatutor.com/) might be a useful resource. 
...
* [TidyDataTutor](https://tidydatatutor.com/) developed by Sean Kross and Phillip Guo 
