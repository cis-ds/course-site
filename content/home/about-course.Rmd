...
```{r pr-wordcloud, fig.cap = "Comments left by students when submitting homework assignments"}
library(tidyverse)
library(tidytext)
library(wordcloud2)

# get PR descriptions from fall 18
evals <- read_rds("../../../grade-report/data/fall-2018-db.Rds")
...
pr_tokens %>%
  ...
  rename(freq = n) %>%
  wordcloud2(widgetsize = c(275, 350))
```
