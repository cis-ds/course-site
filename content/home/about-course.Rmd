...
* Instructor: [Benjamin Soltoff](http://www.bensoltoff.com), Assistant Instructional Professor in [Computational Social Science](http://macss.uchicago.edu)
...
* Office hours:
    ...
    * Patrick: MW 2-3pm, F 9-11am (Regenstein Library, A level)
* Prerequisites: None
