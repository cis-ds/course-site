...
**Information dashboards** provide quick views of information in a succinct and standardized format. They are used frequently in business to report key performance indicators. The goal is to communicate potentially large amounts of quantitative information in a clear and concise manner. The [`flexdashboard`](https://rmarkdown.rstudio.com/flexdashboard/index.html) package uses R Markdown to implement dashboards. They support a range of components, both static and interactive, such as figures, tables, widgets, etc. These dashboards have flexible layouts and intelligently rescale to fill the browser or adapt to display on mobile or tablet devices.
