...
[![Redmonk Q3 2015 Programming Language Rankings](images/lang-rank-615-wm.png)](http://redmonk.com/sogrady/2015/07/01/language-rankings-6-15/)
...
[![xkcd - Python](images/xkcd_python.png)](https://xkcd.com/353/)
...
[Juypter (formerly iPython) Notebooks](http://jupyter.org/) are a popular IDE for writing and executing Python scripts. They combine live code with output and explanatory text to integrate your workflow. The result is a single reproducible document which contains your research and analysis. Jupyter Notebook is installed with Anaconda.
...
![Picture of the RStudio main windows](images/rstudio_startup.png)
