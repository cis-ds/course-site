...
Homework assignments will be stored in separate Git repositories. For each assignment, you will need to take possession of your user-specific repo. These repositories will be part of the `uc-cfss` organization on GitHub, but you will have possession of it. That means you will have full editing rights, but the repo will not directly reside in your user account. So for example, to access your homework repo the link would be something like `https://github.com/uc-cfss/hw00-username`. These repos are also private, so only you and the instructor/TA can view them.

Creating the repo may take a couple minutes but eventually you will receive a link to it. The repo will be listed in your repos on GitHub and can then be cloned to your computer for editing.

# Have a decent `README.md`

Each homework assignment should have a useful `README.md`. This should describe what your repo does, any instructions for how to execute scripts/order to run them, special notes of concern, etc.
...
Whenever you are editing R Markdown documents in RStudio, you can display an R Markdown cheatsheet by going to Help > Cheatsheets > R Markdown Cheat Sheet.
...
* Open an issue, link to the latest commit, and tag the course instructor:
    ...
    * In the issue description, tag Benjamin by including the text `@bensoltoff`, and paste the revision SHA. Include a link to exactly where you want a reviewer to go.
