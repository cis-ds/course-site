...
Go [here](https://github.com/uc-cfss/hw07) to fork the repo for homework 06.
...
1. Estimate three different logistic regression models for survival on the Titanic. You may reuse the same models as last week, or estimate new models.
    1. Estimate the models using the entire set of obserations and calculate the MSE of each model.
    1. Estimate the models using 10-fold CV and calculate the MSE of each model. How do these values compare to the original estimates using the full dataset? Which model performs the best?
